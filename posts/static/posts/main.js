        ...
        data.forEach(el => {
            ...
            <div class="card mt-2">
               <div class="card-body d-flex ">
                ...
                <div class="mx-3">
                 <a class="author" href="${url}${el.author}">${el.author}</a> </br>
                    ${el.title} 
                    <p> ${el.body}</p>
                </div>
            </div>
            <div class ="card-footer">
                <div class="d-flex">
                    ...
                    <form class="like-unlike-forms" data-form-id="${el.id}">
                           <button  id="like-unlike-${el.id}" class="loadmore mx-2">
                            ${el.liked ? `${el.count} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
